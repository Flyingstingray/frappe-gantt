...
class q {
  ...
  calculate_path() {
    let t;
    (this.type === "FS" || this.type === "FF") && (t = this.from_task.$bar.getX() + this.from_task.$bar.getWidth()), (this.type === "SS" || this.type === "SF") && (t = this.from_task.$bar.getX() + this.from_task.$bar.getWidth() / 15);
